...
export default function LoginForm() {
    ...
    async function handleFormSubmit(ev) {
        ev.preventDefault();loginInProgress
    ...
    return (
        <section className="mt-8">
            ...
            <form className="block max-w-xs mx-auto " onSubmit={handleSubmit}>
                ...
                <input type="password" placeholder="password" disabled={loginInProgress} value={password} onChange={ev => setPassword(ev.target.value)} />
