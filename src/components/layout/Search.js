    ...
    return (
      <div>
        <form class="flex items-center max-w-lg mx-auto">
            ...
            <button  type="submit" class="inline-flex items-center py-2.5 px-3 ms-2 text-sm font-medium text-white bg-primary rounded-lg border border-purple-500 hover:bg-purple-500 focus:ring-4 focus:outline-none focus:ring-red-500 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
